const fs=require("fs"),transformExpected=expected=>{if(""===expected)return"''";const parse1=expected.replace(/\/\/.*/,"").trim();return"{"===parse1.substr(0,1)?JSON.parse(parse1.replace(/\n/g,"")):parse1.match(/^['"](.*)['"]$/)?parse1.replace(/'(.*)'/,"$1"):eval(parse1)};void 0===global.StoryBookSections&&(global.StoryBookSections=[]),void 0===global.StoryBookSectionCounter&&(global.StoryBookSectionCounter=0);const parseArgs=t=>"function"!=typeof t[1]?t:[t[0],"",t[1]],storyCreator=mainTitle=>{return global.StoryBookSections.push(`### ${mainTitle}
